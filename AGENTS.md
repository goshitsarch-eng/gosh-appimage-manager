...
- This is an original C++20/Qt 6/KDE Frameworks 6/Kirigami implementation.
...
- Build and test in the KDE 6.10 Flatpak SDK. Real tests, package builds, packaged smoke checks, and documented evidence are required.
